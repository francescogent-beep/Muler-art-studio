        ...
        <div className="max-w-[1600px] mx-auto">
          <div className="flex flex-col md:flex-row justify-between items-end mb-20 gap-8">
            ...
            <div className="flex gap-4 mb-4">
              <button onClick={() => scroll('left')} className="p-4 rounded-full border border-white/10 hover:bg-white/5 text-white transition-all">
                <ChevronLeft size={20} />
              </button>
              <button onClick={() => scroll('right')} className="p-4 rounded-full border border-white/10 hover:bg-white/5 text-white transition-all">
                <ArrowRight size={20} />
              </button>
            </div>
          </div>
            ...
            {BLOG_POSTS.map((post) => (
              ...
              >
                ...
                <div className="max-w-md">
                   <div className="flex items-center gap-3 text-[9px] uppercase tracking-widest text-zinc-500 font-bold mb-4">
