...
export default function Gallery() {
  ...
  return (
    <div className="pt-56 pb-40 animate-reveal">
      <SEO 
        title="Galería de Cortes | Barbería en Murcia | MULER ART STUDIO"
        description="Inspírate con nuestro portfolio de cortes de autor y arreglos de barba. Estilo y técnica visual en nuestra barbería del centro de Murcia."
        slug="galeria"
      ...
      <div className="max-w-[1800px] mx-auto px-8 md:px-16">
        <div className="flex flex-col lg:flex-row justify-between items-start lg:items-end mb-32 border-b border-white/10 pb-20 gap-12">
          <div className="max-w-4xl">
            <span className="text-white/60 uppercase tracking-header text-[10px] font-black block mb-6">Muler Art Studio</span>
            <h1 className="text-7xl md:text-9xl font-serif mb-8 italic leading-[0.8] text-white">Archivo <br/><span className="text-white/70 not-italic">Visual</span></h1>
          </div>
          <div className="max-w-sm lg:text-right">
            <p className="text-zinc-100 text-xs uppercase tracking-[0.4em] leading-relaxed font-bold mb-10">
              Curaduría de estilos, texturas y precisión técnica realizada en nuestro estudio de Murcia.
            </p>
          ...
          {allImages.map((img, i) => (
            ...
            >
              <img 
                ...
                alt={`Muler Art Studio Detalle de Corte Murcia ${i}`} 
                width="800"
                height="800"
                decoding="async"
              ...
              <div className="absolute inset-0 bg-gradient-to-t from-black/80 via-transparent to-transparent opacity-0 group-hover:opacity-100 transition-all duration-700 flex flex-col justify-end p-8">
                <div className="translate-y-4 group-hover:translate-y-0 transition-transform duration-700">
                  ...
                  <span className="text-lg italic font-serif text-white">Técnica de Autor en Murcia</span>
                </div>
              </div>
            </div>
          ))}
        ...
        <div className="mt-56 text-center border-t border-white/5 pt-32">
          <span className="text-[10px] uppercase tracking-header text-white/40 font-black block mb-8">¿Deseas este acabado?</span>
