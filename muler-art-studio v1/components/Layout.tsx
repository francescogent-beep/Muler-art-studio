          ...
          <nav className="hidden md:flex gap-12 items-center">
            {links.map(l => (
              <Link 
                key={l.path} 
                to={l.path} 
                className={`text-[10px] uppercase tracking-[0.4em] font-medium transition-all hover:text-white ${location.pathname === l.path ? 'text-white' : 'text-zinc-300'}`}
              >
                {l.name}
              </Link>
            ))}
      ...
      >
        ...
        >
          ...
          <a 
            ...
            className="flex items-center justify-center gap-3 border border-white/10 py-5 text-[10px] uppercase tracking-[0.3em] font-bold text-zinc-300 rounded-full"
          >
      ...
      <div className="max-w-[1800px] mx-auto px-8 md:px-16 grid grid-cols-1 md:grid-cols-12 gap-20">
        <div className="md:col-span-4">
          ...
          <div className="flex gap-10">
            <a href="https://instagram.com/mulerartstudio" target="_blank" rel="noopener noreferrer" className="text-zinc-200 hover:text-white transition-colors flex items-center gap-2 text-[10px] uppercase tracking-widest font-bold">
              <Instagram size={16} strokeWidth={1}/> INSTAGRAM
            </a>
            <a href={`https://wa.me/${CONTACT.whatsapp}`} target="_blank" rel="noopener noreferrer" className="text-zinc-200 hover:text-white transition-colors flex items-center gap-2 text-[10px] uppercase tracking-widest font-bold">
