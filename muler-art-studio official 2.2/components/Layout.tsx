...
import { Menu, X, Instagram, Phone, MessageCircle, MapPin, Plus, Minus, Navigation } from 'lucide-react';
...
const FindUsBlock = () => (
  <section className="bg-zinc-950 border-t border-white/5 py-12">
    <div className="max-w-[1800px] mx-auto px-8 md:px-16 flex flex-col md:flex-row items-center justify-between gap-8">
      <div className="flex items-center gap-6">
        <div className="w-12 h-12 glass-premium rounded-full flex items-center justify-center text-white shrink-0 border border-white/10">
          <Navigation size={20} />
        </div>
        <div>
      ...
      <a 
        ...
        className="text-[10px] uppercase tracking-premium font-black text-white border-b border-white/20 pb-1 hover:border-white transition-all flex items-center gap-3"
      >
        VER MAPA EN SAN BASILIO <MapPin size={14} />
      </a>
    </div>
  </section>
);
...
const MobileFloatingButtons = () => (
  <div className="md:hidden fixed bottom-6 left-6 right-6 z-[100] flex gap-3 animate-reveal">
    <a 
    ...
    <a 
      href={CONTACT.booksyUrl} 
      className="booksy-widget-button flex-[1.5] bg-white text-black flex items-center justify-center gap-3 py-4 rounded-full font-bold text-[10px] uppercase tracking-widest shadow-lg shadow-white/20"
    >
      RESERVAR CITA
    </a>
  </div>
      ...
      <footer className="bg-black pt-32 pb-16 border-t border-white/10">
        <div className="max-w-[1800px] mx-auto px-8 md:px-16 grid grid-cols-1 md:grid-cols-12 gap-20">
          <div className="md:col-span-4">
            ...
            <p className="text-zinc-100 max-w-sm text-sm leading-relaxed font-light mb-12 italic">
              "Un santuario dedicado a la estética masculina donde el arte y la precisión convergen para redefinir el estilo personal en el barrio de San Basilio, Murcia."
            </p>
          ...
          <div className="md:col-span-4 flex flex-col">
            <div className="flex flex-col gap-3 text-xs text-zinc-100 font-light">
               <h3 className="text-[10px] uppercase tracking-[0.5em] text-white font-bold mb-6">Navegación</h3>
              ...
              <div className="flex flex-col gap-8 text-xs text-zinc-100 font-light leading-relaxed">
                <div className="flex items-start gap-4">
                  ...
                  <p>
                    ...
                    {CONTACT.postalCode} Murcia (Barrio San Basilio)
                  </p>
                </div>
        ...
        <div className="max-w-[1800px] mx-auto px-8 md:px-16 mt-24 pt-12 border-t border-white/10 flex flex-col items-center gap-8 text-[9px] text-white/80 uppercase tracking-[0.5em] font-bold">
          <div className="flex flex-col md:flex-row items-center gap-8 md:gap-12">
            <div className="flex gap-10">
              <span className="text-white uppercase">Diseño de Autor</span>
              <span className="text-white uppercase">Murcia</span>
            </div>
            <a href="https://fgdigitalsystems.com" target="_blank" rel="noopener noreferrer" className="text-white md:border-l md:border-white/10 md:pl-12">
              web by <span className="text-white">FGDIGITALSYSTEMS</span>
            </a>
          </div>
          <span className="text-white/70 pt-4 border-t border-white/5 w-full text-center uppercase tracking-widest">
            MULER ART STUDIO © {new Date().getFullYear()}
          </span>
        </div>
      </footer>
    </>
