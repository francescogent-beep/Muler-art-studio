...
import { SERVICES, CONTACT, optimizeImg } from '../data';
  ...
  const itemListSchema = {
    ...
    "itemListElement": SERVICES.map((s, i) => ({
      ...
      "item": {
        ...
        "url": `https://mulerartstudio.com/${s.slug}`,
        "offers": {
          "@type": "Offer",
      ...
      <div className="max-w-[1600px] mx-auto px-8 md:px-16">
        <div className="max-w-4xl mb-20">
          ...
          <p className="text-zinc-100 text-lg md:text-xl font-light leading-relaxed max-w-2xl tracking-wide">
            ...
            Nuestra <Link to="/sobre-nosotros" className="text-white underline decoration-white/20">historia</Link> se basa en la disciplina.
            ...
            >
              ...
              <div className="p-8 flex flex-col flex-grow">
                <div className="flex justify-between items-start mb-4">
                  <h3 className="text-2xl md:text-3xl font-serif italic text-white group-hover:text-zinc-100 transition-colors leading-tight">
                    {s.title}
                  </h3>
                ...
                <p className="text-zinc-200 font-light text-sm leading-relaxed mb-8 line-clamp-2">
                  {s.description}
                </p>
                ...
                <div className="mt-auto flex justify-between items-center pt-5 border-t border-white/5">
                  ...
                  <div className="flex gap-2">
                    {s.keywords.slice(0, 1).map(kw => (
                      <span key={kw} className="text-[8px] uppercase tracking-widest text-white/30">#{kw.split(' ')[0]}</span>
                    ))}
                  </div>
                </div>
              </div>
        ...
        <div className="mt-32 text-center">
            <a 
                ...
                className="booksy-widget-button inline-block border border-white/10 px-16 py-6 text-[11px] uppercase tracking-premium font-black text-white hover:bg-white hover:text-black transition-all duration-700 rounded-full text-center"
            >
