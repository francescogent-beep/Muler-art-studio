...
const REVIEWS = [
  ...
  "«Extremadamente profesional con un trato agradable. Puntualidad y excelencia.» — A. Sánchez",
    ...
    <div className="animate-reveal">
      ...
      <section className="relative h-screen flex items-center justify-center bg-black overflow-hidden">
        <div className="absolute inset-0 z-0 overflow-hidden bg-black">
          {/* Removed non-standard fetchPriority to resolve TS errors in VideoHTMLAttributes */}
          <video
            autoPlay
            muted
            loop
      ...
      {/* Featured Visual Section (Gallery) - Actualizado con la foto interior de autor */}
      ...
      {/* Location Section */}
      <section className="py-32 bg-black px-8 overflow-hidden relative">
        <div className="max-w-[1600px] mx-auto grid grid-cols-1 lg:grid-cols-2 gap-24 items-center">
          ...
          <div className="h-[500px] lg:h-[700px] neon-border rounded-2xl overflow-hidden grayscale invert brightness-[0.6] contrast-[1.3] opacity-60 hover:opacity-100 hover:brightness-100 transition-all duration-[1.5s]">
            <iframe 
