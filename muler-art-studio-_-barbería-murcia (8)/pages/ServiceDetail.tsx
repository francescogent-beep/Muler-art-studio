...
import { CONTACT, IMAGES, SERVICES } from '../data';
...
export default function ServiceDetail({ service }: Props) {
  // Find other services for interlinking
  ...
  return (
    <div className="pt-40 pb-32 animate-in slide-in-from-right duration-700">
      ...
      <div className="max-w-7xl mx-auto px-6">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-20">
          <div>
            ...
            <p className="text-zinc-200 text-lg font-light leading-relaxed mb-12">
              {service.description} Realizado por expertos barberos que combinan la técnica clásica con las últimas tendencias del sector. En MULER ART STUDIO garantizamos un acabado milimétrico y una experiencia de confort total.
            </p>
            ...
            <div className="flex flex-col sm:flex-row gap-6">
                ...
                <Link 
                  to="/reservar"
                  className="inline-flex items-center justify-center gap-4 border border-white/20 text-white px-12 py-5 text-[10px] uppercase tracking-widest font-bold hover:bg-white hover:text-black transition-all rounded-full"
                >
                  Reservar Online
                </Link>
            </div>
          ...
          <div className="relative">
             <div className="aspect-[4/5] glass p-4 rounded-3xl overflow-hidden">
                <img src={service.image || IMAGES.portfolio[2]} className="w-full h-full object-cover" alt={service.title} />
             </div>
        ...
        {/* Smart Navigation: Related Services */}
        <div className="mt-40 border-t border-white/5 pt-20">
          <div className="flex justify-between items-end mb-16">
            <h2 className="text-4xl md:text-5xl font-serif italic text-white">Otros Servicios</h2>
            ...
            {otherServices.map(s => (
              <Link key={s.id} to={`/${s.slug}`} className="group block">
                <div className="aspect-[16/9] mb-6 overflow-hidden rounded-xl neon-border">
                  <img src={s.image} alt={s.title} className="w-full h-full object-cover grayscale brightness-75 group-hover:grayscale-0 group-hover:brightness-100 transition-all duration-700" />
                </div>
        ...
        <div className="mt-32 border-t border-white/10 pt-20">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            ...
            <div className="glass p-8 italic text-zinc-200 font-light text-sm leading-relaxed rounded-2xl">
              "Profesionalidad y puntualidad. Se nota que aman lo que hacen. 100% recomendado el {service.title}."
            </div>
            <div className="glass p-8 italic text-zinc-200 font-light text-sm leading-relaxed rounded-2xl">
              "Ubicación céntrica y trato inmejorable. MULER ART STUDIO es mi nueva barbería de referencia."
            </div>
          </div>
        </div>
      </div>
