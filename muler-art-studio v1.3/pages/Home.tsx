    ...
    <div>
      ...
      <section className="relative h-screen flex items-center justify-center bg-black overflow-hidden">
        ...
        <div className="relative z-30 text-center px-6 max-w-[1400px]">
          ...
          <div className="flex flex-col md:flex-row gap-10 justify-center items-center animate-reveal [animation-delay:350ms]">
            <Link to="/reservar" className="w-full md:w-auto border border-white/20 bg-white/5 backdrop-blur-md px-20 py-6 text-[11px] uppercase tracking-premium font-black text-white hover:bg-white hover:text-black transition-all duration-1000 rounded-full">
              RESERVAR CITA
            </Link>
            <Link to="/servicios" className="w-full md:w-auto text-white hover:text-zinc-200 text-[11px] uppercase tracking-premium font-black transition-all">
              VER SERVICIOS
            </Link>
          </div>
        </div>
          ...
          {[...REVIEWS, ...REVIEWS].map((review, i) => (
            <div key={i} className="flex items-center gap-14 px-14">
              <div className="flex items-center gap-4">
                ...
                <span className="text-[10px] font-black uppercase tracking-widest text-white/60 ml-2">Google Reviews</span>
              </div>
      ...
      <section className="relative h-[80vh] flex items-center justify-center overflow-hidden group">
        ...
        <div className="relative z-10 text-center px-6">
            <span className="text-white uppercase tracking-[0.8em] text-[10px] font-black block mb-10 opacity-100 uppercase">The Studio</span>
