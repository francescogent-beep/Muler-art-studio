      ...
      <section className="relative h-screen flex items-center justify-center bg-black overflow-hidden">
        ...
        <div className="relative z-30 text-center px-6 max-w-[1400px]">
          <div className="overflow-hidden mb-10">
            <span className="block uppercase tracking-header text-[7px] md:text-[10px] text-zinc-100 font-black animate-reveal [animation-delay:50ms]">
          ...
          {[...REVIEWS, ...REVIEWS].map((review, i) => (
            <div key={i} className="flex items-center gap-14 px-14">
              <div className="flex items-center gap-4">
                ...
                <span className="text-[10px] font-black uppercase tracking-widest text-black/60 ml-2 text-zinc-600">Google Reviews</span>
              </div>
